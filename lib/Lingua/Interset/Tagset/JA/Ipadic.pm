...
binmode(STDIN, ':utf8');    # so we can use japanese characters as hash keys
...
(
    ...
    '名詞-固有名詞-一般'    => ['pos' => 'noun', 'nountype' => 'prop'], # noun-proper-misc 
    '名詞-固有名詞-人名'    => ['pos' => 'noun', 'nountype' => 'prop', 'nametype' => 'prs'], # noun-proper-person
    '名詞-固有名詞-人名-一般'   => ['pos' => 'noun', 'nountype' => 'prop', 'nametype' => 'prs'], # noun-proper-person-misc
    ...
    '名詞-固有名詞-地域-一般'   => ['pos' => 'noun', 'nountype' => 'prop', 'nametype' => 'geo'], # noun-proper-place-misc
    ...
    '名詞-代名詞-一般'  => ['pos' => 'noun', 'prontype' => 'prn'], # noun-pronoun-misc
    ...
    '名詞-非自立-一般'  => ['pos' => 'noun', 'other' => 'affix'], # noun-affix-misc
    ...
    '名詞-接尾-一般'    => ['pos' => 'noun', 'other' => 'suffix'], # noun-suffix-misc
    ...
    '動詞'              => ['pos' => 'verb'], # verb
    '動詞-自立'         => ['pos' => 'verb'], # verb-main (independent)
    ...
    '助詞-格助詞-一般'  => ['pos' => 'adp', 'adpostype' => 'post', 'other' => 'case'], # particle-case-misc
    ...
    '記号'              => ['pos' => 'punc', 'punctype' => 'symbol'], # symbol
    '記号-一般'         => ['pos' => 'punc', 'punctype' => 'symbol'], # symbol-misc
    ...
    '記号-アルファベット'   => ['pos' => 'punc', 'punctype' => 'symbol', 'other' => 'alphabet'], # symbol-alphabetic
...
sub encode
{
    ...
    elsif ($pos eq 'noun')
    {
      if ($fs->nountype())
      {
        ...
        else
        {
          ...
          # noun-proper-place-misc noun-proper-place-country
      ...
      # noun-pronoun-contraction noun-pronoun-misc
      elsif ($fs->prontype())
      {
    ...
    {
      # symbol-alphabetic symbol-misc
      if ($fs->punctype() eq 'symbol')
      {
