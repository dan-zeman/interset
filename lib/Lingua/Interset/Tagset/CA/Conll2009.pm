...
sub _create_atoms
{
    ...
    (
        ...
        'decode_map' =>
        {
            ...
            'z' => ['pos' => 'num'],
            'w' => ['pos' => 'noun'], # date, name of the day of week
            'v' => ['pos' => 'verb'],
            'r' => ['pos' => 'adv'],
            's' => ['pos' => 'adp', 'adptype' => 'prep'],
            'c' => ['pos' => 'conj'],
            'i' => ['pos' => 'int'],
            'f' => ['pos' => 'punc']
        },
    ...
    (
        ...
        'decode_map' =>
        {
            ...
            'article'       => ['adjtype'  => 'art'], ###!!! Should this be a prontype???
            ...
            'auxiliary'     => ['verbtype' => 'aux'], # haber
            'semiauxiliary' => ['verbtype' => 'aux'], # ser; Interset cannot distinguish semiauxiliary from auxiliary
            # prepositions
    ...
    (
        ...
        'simple_decode_map' =>
        {
            'm' => 'masc',
            'f' => 'fem',
            # The common gender in Catalan is probably different from the common gender in Swedish, for which the Interset value 'com' was added.
            # So we might actually want to use 'masc|fem' instead.
            # Or should we lave it empty because there is no neuter in Catalan and common thus means any/unknown gender?
            'c' => 'com'
        }
    );
    # NUMBER ####################
    ...
    # POSSESSOR NUMBER ####################
    $atoms->{possessornum} = $self->create_simple_atom
    (
