...
# tagset_to_uposf_table.pl lt::jablonskis lt-jablonskis > Documents\Lingvistika\Projekty\universal-dependencies\docs\_tagset-conversion\lt-jablonskis-uposf.md
